    ...
    <section class="admin-table-shell">
        <div class="flex items-center justify-between border-b border-[var(--color-admin-border)] px-4 py-3 dark:border-[var(--color-admin-border-dark)]">
            ...
            <div class="flex items-center gap-2">
                ...
                <a href="{{ route('admin.node-connections.create') }}" class="admin-btn admin-btn-primary">New Connection</a>
            </div>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex justify-end gap-1.5">
                                    <a href="{{ route('admin.node-connections.edit', $connection) }}" class="admin-btn-sm admin-btn-ghost">Edit</a>
