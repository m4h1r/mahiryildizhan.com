        ...
        <div class="grid min-h-screen lg:grid-cols-[260px_1fr]">
            ...
            >
                ...
                <nav class="admin-scrollbar flex-1 overflow-y-auto px-3 py-4">
                    {{-- Main --}}
                    <div class="mb-4">
                        <p class="mb-1 px-3 text-[11px] font-semibold uppercase tracking-widest text-gray-400 dark:text-gray-500">{{ __('Main') }}</p>
                    ...
                    {{-- People & Relations --}}
                    <div class="mb-4">
                        <p class="mb-1 px-3 text-[11px] font-semibold uppercase tracking-widest text-gray-400 dark:text-gray-500">{{ __('People & Relations') }}</p>
                        <div class="space-y-0.5">
                    ...
                    {{-- Content --}}
                    <div class="mb-4">
                        <p class="mb-1 px-3 text-[11px] font-semibold uppercase tracking-widest text-gray-400 dark:text-gray-500">{{ __('Content') }}</p>
                        <div class="space-y-0.5">
                            ...
                            <a href="{{ route('admin.links.index') }}" class="admin-nav-link {{ request()->routeIs('admin.links.*') ? 'admin-nav-link-active' : '' }}">
                                <svg class="h-[18px] w-[18px] shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path stroke-linecap="round" stroke-linejoin="round" d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>
                                {{ __('Links') }}
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="space-y-0.5">
                            ...
                            <a href="{{ route('admin.milestones.index') }}" class="admin-nav-link {{ request()->routeIs('admin.milestones.*') ? 'admin-nav-link-active' : '' }}">
                                <svg class="h-[18px] w-[18px] shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M3 21v-4m0 0V5a2 2 0 0 1 2-2h6.5L21 13l-5.5 5.5H3v-1.5Z"/></svg>
                                {{ __('Kilometre Taşları') }}
                            </a>
                        </div>
                    </div>
                    ...
                    {{-- System --}}
                    <div class="mb-4">
                        <p class="mb-1 px-3 text-[11px] font-semibold uppercase tracking-widest text-gray-400 dark:text-gray-500">{{ __('System') }}</p>
                        <div class="space-y-0.5">
...
<a href="{{ route('admin.settings') }}" class="admin-nav-link {{ request()->routeIs('admin.settings') ? 'admin-nav-link-active' : '' }}">
                    ...
                    {{-- Dictionaries --}}
                    <div>
                        <p class="mb-1 px-3 text-[11px] font-semibold uppercase tracking-widest text-gray-400 dark:text-gray-500">{{ __('Dictionaries') }}</p>
                        <div class="space-y-0.5">
